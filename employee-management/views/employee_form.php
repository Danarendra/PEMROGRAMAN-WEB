...
<form method="POST" action="<?php echo $form_action; ?>"> 
    ...
    <div class="form-group"> 
        ...
        <input type="number" id="salary" name="salary" class="form-input" 
               ...
               required min="0" placeholder="Contoh: 5000000"> 
    ...
    <div class="form-group" style="display: flex; gap: 1rem; margin-top: 2rem;"> 
        ...
        <?php if ($is_edit): ?> 
            <a href="index.php?action=delete&id=<?php echo $employee['id']; ?>" class="btn btn-delete" 
               onclick="return confirm('Yakin ingin menghapus karyawan <?php echo htmlspecialchars($employee['first_name'] . ' ' . $employee['last_name']); ?>?');">Hapus Karyawan</a> 
        <?php endif; ?> 
    </div> 
</form> 
...
document.querySelector('form').addEventListener('submit', function(e) {
    ...
    // Validasi tanggal mulai bekerja tidak boleh lebih dari hari ini
    if (hireDate > today) {
